...
CREATE TABLE programs (
    ...
    end_date DATE,
    status VARCHAR(30) DEFAULT 'Planning' CHECK (status IN ('Planning', 'Active', 'Completed', 'On Hold', 'Cancelled')),
...
CREATE TABLE program_indicators (
    ...
    indicator_type VARCHAR(50) NOT NULL CHECK (indicator_type IN ('Input', 'Output', 'Outcome', 'Impact')),
    description TEXT,
    unit_of_measure VARCHAR(50) NOT NULL,
    target_value DECIMAL(15,2) NOT NULL,
    current_value DECIMAL(15,2) DEFAULT 0.00,
    baseline_value DECIMAL(15,2) DEFAULT 0.00,
    data_source VARCHAR(200),
    collection_frequency VARCHAR(50) DEFAULT 'Monthly' CHECK (collection_frequency IN ('Daily', 'Weekly', 'Monthly', 'Quarterly', 'Annually')),
    responsible_person VARCHAR(100),
    status VARCHAR(50) DEFAULT 'On Track' CHECK (status IN ('On Track', 'Behind', 'At Risk', 'Achieved')),
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
